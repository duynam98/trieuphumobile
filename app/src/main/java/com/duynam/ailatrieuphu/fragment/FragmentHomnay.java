...
public class FragmentHomnay extends Fragment {
    ...
    private RecyclerView rv_homnay;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv_homnay = view.findViewById(R.id.rv_homnay);
        getUsser();
    ...
    private void getUsser() {
        date = new Date();
        String currendate = new SimpleDateFormat("dd,MM,yyyy").format(date.getTime());
        final FirebaseDatabase database = FirebaseDatabase.getInstance();
        Query homnay = database.getReference("Users").orderByChild("timestamp").equalTo(currendate);
        ...
        homnay.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    rv_homnay.setLayoutManager(layoutManager);
                    rv_homnay.setAdapter(adapter);
                }
            }
